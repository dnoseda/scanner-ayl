...
public enum TokenType {
	ENTERO(1), ID(2), CADENA(3), REAL(4), CARACTER(5), SEP(6), ERROR(7), ABSTRACT(
			...
			,TITLE_TAG_NAME(91),P_TAG_NAME(92),TITLE(93), CHAR_ERROR(94), CADENA_INCOMPLETA_ERROR(95), CARACTER_ERROR(96),ERROR_GENERICO(97), ERROR_QUOTE_ASCII(98), ERROR_QUOTE_CDATA(99);
